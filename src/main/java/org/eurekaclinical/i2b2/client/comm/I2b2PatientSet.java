 ...
 */
/**
 * A bean for i2b2 patient sets. Used for retrieving PDO results for formatting
 * from i2b2. Instances of this class will generally be created and populated
 * using JSON objects sent by the client.
 *
