...
/**
 * Container for i2b2 PDO results. Holds all of the patients, events, observers,
 * and observations parsed from a PDO result XML response.
 *
...
public class I2b2PdoResults {
    ...
    /**
     * Default constructor. Accepts the patients, events, observers, and
     * observations.
     *
